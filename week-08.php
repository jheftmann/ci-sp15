					...
					<div class="container-fluid">
						<div class="inner">
							...
							<div class="section-content">
								...
								<br>
								<h5 class="txt-strong">Assignment 2&#8212;due by Monday, March 30</h5>
								<p>Complete the last two modules on Codecademy:</p>
								<ol>
									<li><p>CSS Positioning</p></li>
									<li><p>Build a resume</p></li>
								</ol>
